...
export default function TVGames() {
  return (
    <Block title={'Bwanabet Virtual Sports'}>
      ...
      <div className="px-10 mb-6">
        <ul className="list-disc list-inside text-sm mt-3">
          <li>Cyber Football;</li>
          <li>Counter-Strike;</li>
          <li>Dota 2;</li>
          <li>Cyberbasketball;</li>
          <li>Cyber Tennis;</li>
          <li>The world of Tanks;</li>
          <li>Cyber Hockey;</li>
          <li>Cyber fighting;</li>
          <li>Battlefield and others.</li>
        </ul>
      </div>

      <p className="mb-6 text-gray-800">
        Betting on cybersports can be done before the start of the match — prematch, and in real-time — Live. Bets on cybersports disciplines are available round the clock.
      </p>
    </Block>
  )
}